	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-10.0F, -20.0F, -10.0F, 20.0F, 20.0F, 20.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-10.0F, -20.0F, -10.0F, 20.0F, 20.0F, 20.0F, new CubeDeformation(0.5F)).texOffs(0, 40)
						.addBox(-10.0F, 0.0F, -10.0F, 20.0F, 6.0F, 20.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition saddle = Body.addOrReplaceChild("saddle",
				CubeListBuilder.create().texOffs(0, 66)
						.addBox(-6.0F, -36.0F, -8.0F, 12.0F, 1.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(40, 66)
						.addBox(-6.0F, -43.0F, 8.0F, 12.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 15.0F, 0.0F));

		PartDefinition rightleg = partdefinition.addOrReplaceChild("rightleg", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-2.0F, -0.5F, -2.0F, 4.0F, 15.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-4.0F, 9.5F, 0.0F));
