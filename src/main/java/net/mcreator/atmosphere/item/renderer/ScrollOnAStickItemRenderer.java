...
import net.mcreator.atmosphere.interfaces.RendersPlayerArms;
...
public class ScrollOnAStickItemRenderer extends GeoItemRenderer<ScrollOnAStickItem> implements RendersPlayerArms {
	public ScrollOnAStickItemRenderer() {
		super(new ScrollOnAStickItemModel());
	}

	@Override
	public RenderType getRenderType(ScrollOnAStickItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof ScrollOnAStickItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new ScrollOnAStickItemRenderer();
	...
	protected ScrollOnAStickItem animatable;
	...
	@Override
	public void render(GeoModel model, ScrollOnAStickItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(ScrollOnAStickItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(ScrollOnAStickItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(ScrollOnAStickItem animatable) {
