...
public class PetalParadiseBiome {
	public static Biome createBiome() {
		BiomeSpecialEffects effects = new BiomeSpecialEffects.Builder().fogColor(-273411).waterColor(-10881563).waterFogColor(-10881563).skyColor(-273411).foliageColorOverride(-14003674).grassColorOverride(-14003674).build();
