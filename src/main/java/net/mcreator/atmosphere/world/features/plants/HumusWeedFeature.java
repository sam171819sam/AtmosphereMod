...
public class HumusWeedFeature extends RandomPatchFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("atmosphere:humus_weed", FEATURE,
				FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(AtmosphereModBlocks.HUMUS_WEED.get())), List.of(), 64));
		PLACED_FEATURE = PlacementUtils.register("atmosphere:humus_weed", CONFIGURED_FEATURE, List.of(CountPlacement.of(14), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome()));
		return FEATURE;
	}
