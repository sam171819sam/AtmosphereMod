...
public class AtmosphereDimensionPortalShape {
	...
	public static Optional<AtmosphereDimensionPortalShape> findPortalShape(LevelAccessor p_77713_, BlockPos p_77714_,
			Predicate<AtmosphereDimensionPortalShape> p_77715_, Direction.Axis p_77716_) {
		Optional<AtmosphereDimensionPortalShape> optional = Optional.of(new AtmosphereDimensionPortalShape(p_77713_, p_77714_, p_77716_))
				.filter(p_77715_);
